...
namespace Real_estate.Domain.Entities
{
    ...
    {
        public Property(string title, string address, int size, int price, Status propertyStatus, Guid ownerId, int numberOfBedrooms)
        {
        ...
        public static Result<Property> Create( string title, string address, int size, int price, Status propertyStatus, Guid ownerId, int numberOfBedrooms, List<string> imagesUrl)
        {
